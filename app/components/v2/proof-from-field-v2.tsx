...
export function ProofFromFieldV2() {
  return (
    <section
      id="proof"
      className="overflow-x-clip border-y border-border py-20 md:py-24"
    ...
    >
      <div className="mx-auto max-w-6xl px-6 md:px-10 lg:px-16">
        <FadeIn>
          ...
          <h2
            id="proof-heading"
            className="mt-4 max-w-3xl font-serif text-[clamp(1.75rem,3.5vw,2.5rem)] leading-[1.15] font-medium tracking-[-0.02em] text-foreground"
          >
