...
export const introV2 = [
  ...
  "Before entering residential services, I spent twenty-five years helping customers make important decisions in education, publishing, technology, and consumer brands.",
  "Today, I'm focused on bringing that same consultative approach to helping homeowners navigate important decisions about their homes.",
] as const;
